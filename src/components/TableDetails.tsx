...
export const TableDetails = ({ table, catalog, onBack }: TableDetailsProps) => {
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-console-grey">{catalog.name} catalog</p>
            </div>
          </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card className="p-6 border border-console-light-grey">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <p className="text-sm text-console-grey">Catalog</p>
                <p className="font-medium text-foreground">{catalog.name}</p>
              </div>
              <div>
                <p className="text-sm text-console-grey">Schema</p>
                <p className="font-medium text-foreground">{table.schema}</p>
              </div>
              <div>
